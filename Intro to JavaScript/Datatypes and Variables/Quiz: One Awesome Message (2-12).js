...
// Add your code here
var firstName = "Ian";
var interest = "Atomic Energy";
var hobby = "juggle";
var awesomeMessage = "Hi, my name is _____. I love _____. In my spare time, I like to _______.";
awesomeMessage = awesomeMessage.replace("_____", firstName).replace("_____", interest).replace("_______", hobby);
